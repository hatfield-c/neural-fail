...
pipelines = {
	...
	### Chess pipelines
	"linear_chess": Pipeline.Pipeline("linear", "chess", 1e-3, 1000, 100, star_ablations),
	"linear_norm_chess": Pipeline.Pipeline("linear_norm", "chess", 1e-3, 1000, 100, star_ablations),
	"vgg16_chess": Pipeline.Pipeline("vgg16", "chess", 1e-5, 1000, 10, star_ablations),
	"deepset_chess": Pipeline.Pipeline("deepset", "chess", 1e-3, 3000, 100, star_ablations),
}
